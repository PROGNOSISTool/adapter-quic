...
ENV GOPATH /go
RUN go mod download
RUN cd $(ls -d /go/pkg/mod/github.com/!p!r!o!g!n!o!s!i!s!tool/pigotls*) && go mod download && make
RUN cd $(ls -d /go/pkg/mod/github.com/!p!r!o!g!n!o!s!i!s!tool/ls-qpack-go*) && go mod download && make
