...
func NewTLSTransportParameterHandler(scid ConnectionID) *TLSTransportParameterHandler {
	return &TLSTransportParameterHandler{QuicTransportParameters: QuicTransportParameters{
		MaxStreamDataBidiLocal: 16 * 1024,
		MaxStreamDataUni: 16 * 1024,
		MaxData: 32 * 1024,
		MaxBidiStreams: 1,
		MaxUniStreams: 3,
		// 2 days timeout, AKA just dont.
		IdleTimeout: 2 * 24 * 60 * 60 * 1000,
		AckDelayExponent: 3,
		MaxAckDelay: 10000,
		ActiveConnectionIdLimit: 4,
		InitialSourceConnectionId: scid,
	}}
}
